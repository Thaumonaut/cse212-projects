...
public static class Recursion
{
    ...
    public static void PermutationsChoose(List<string> results, string letters, int size, string word = "")
    {
        ...
        for (int i = 0; i < letters.Length; i++)
        {
            ...
            PermutationsChoose(results, lettersRemaining, size - 1, word + letters[i]);
        }
    }
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        var p0 = pattern.ToCharArray();
        var p1 = pattern.ToCharArray();
        if(wildcardIndex == -1)
        {
            results.Add(pattern);
            return;
        ...
        WildcardBinary(new string(p0), results);
        WildcardBinary(new string(p1), results);
